      ...
      <div className="max-w-6xl mx-auto">
          ...
          <div className=" dark:bg-transparent rounded-2xl shadow-lg border border-gray-100 dark:border-none p-6 md:p-8">
            ...
            <ul className="grid gap-6">
              {values.map((value, idx) => (
                <li key={idx} className="flex items-start gap-4 rounded-md p-3">
                  <FontAwesomeIcon
                    icon={faCircleCheck}
        ...
        <div className=" py-24">
          ...
          <p className="text-center text-lg md:text-xl text-gray-500 max-w-3xl mx-auto mb-12">
            Discover how our users and partners are making a tangible impact on
            the environment. Their stories fuel our mission and showcase the
            power of collective action in recycling.
          </p>
