...
const CategoryActions = ({ setShowCounter }) => {
  return (
    <div className="px-6 pb-6 space-y-3">
      ...
      <button className="w-full bg-gray hover:bg-gray-200 text-gray-700 dark:hover:bg-gray-700  dark:text-gray-500  py-2 px-3 text-sm rounded-xl font-medium transition-colors flex items-center justify-center gap-2 border border-gray-200">
        <Truck size={20} />
