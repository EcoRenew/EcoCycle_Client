      ...
      <div className="border-2 border-dashed border-gray-300 rounded-lg p-8 mb-4">
        {uploadedImage ? (
          <div className="relative">
            <img src={uploadedImage} alt="Uploaded item" className="max-w-xs max-h-48 mx-auto rounded-lg" />
            <button
          ...
          <>
            ...
            <h3 className="text-lg font-medium text-gray-900 mb-2">Or upload an image of your item</h3>
            <p className="text-gray-500 mb-4">Drag and drop or click to browse and upload an image of the item you want to repurpose.</p>
          </>
        )}
      </div>
