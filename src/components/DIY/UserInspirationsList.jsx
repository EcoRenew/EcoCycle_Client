...
const UserInspirationsList = ({ inspirations }) => (
  <div>
    <div className="flex justify-between items-center mb-6">
      <h2 className="text-2xl font-bold text-gray-900">User Inspiration</h2>
      <button className="text-green-600 hover:text-green-700 text-sm font-medium">View more</button>
    </div>
